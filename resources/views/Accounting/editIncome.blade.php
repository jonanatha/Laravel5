    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 form-group">
                ...
                <?php
                $row = DB::table('income')->where('id', $id)->first();
                ?>
                <div class="bs-example" data-example-id="horizontal-static-form-control">
                    <form class="form-inline" action="<?= URL::to('/editIncome') ?>" method="post">
            ...
            <table class="table">
              ...
              <tbody>
                <?php
                $income_row = DB::table('income')->where('userID', Auth::user()->id )->paginate(10);//get();
